...
/ * Wir warten immer ein bisschen zwischen Updates der Anzeige * /
...
/*
  Diese Funktion leuchtet ein paar Leds in einer Reihe.
  Das Muster wird in jeder Zeile wiederholt.
  Das Muster blinkt mit der Zeilennummer.
  Zeilennummer 4 (Index == 3) blinkt 4 mal usw.
 */
void rows() {
...
/*
  Diese Funktion leuchtet ein paar Leds in einer Spalte.
  Das Muster wird auf jeder Spalte wiederholt.
  Das Muster blinkt mit der Spaltennummer.
  Spalte Nummer 4 (Index == 3) blinkt 4 mal usw.
 */
void columns() {
...
/* 
 Diese Funktion leuchtet alle Led auf der Matrix auf.
  Die LED blinkt mit der Zeilennummer.
  Zeilennummer 4 (Index == 3) blinkt 4 mal usw.
 */
void single() {
  for(int row=0;row<8;row++) {
